    ...
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col max-w-md mx-auto">
      ...
      <div className="flex-1 flex flex-col p-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex flex-col items-center">
                <button
                  ...
                  className="w-16 h-16 border-4 border-[#F0F0F0] text-[#F0F0F0] hover:bg-[#FF006E] hover:border-[#FF006E] hover:text-[#F0F0F0] transition-colors"
              ...
              <div className="text-8xl text-[#FF006E] mb-8" style={{ fontFamily: 'var(--font-mono)' }}>:</div>
        ...
        <div className="mt-8">
          ...
          <div className="space-y-3">
            {apps.map((app) => (
              <div
                key={app.id}
                className="flex items-center justify-between p-4 border-4 border-[#F0F0F0] bg-[#16161d]"
              >
                ...
                <button
                  ...
                  className={`relative w-16 h-8 border-4 border-[#F0F0F0] transition-colors ${
                    app.enabled ? 'bg-[#00F5FF]' : 'bg-[#2a2a3a]'
                  }`}
                >
                  <div
        ...
        <button
          ...
          className="mt-6 w-full py-6 border-4 border-[#F0F0F0] bg-[#FF006E] text-[#F0F0F0] hover:bg-[#CC0057] disabled:bg-[#1f1f2a] disabled:text-[#505050] disabled:cursor-not-allowed transition-colors"
          style={{ fontFamily: 'var(--font-mono)' }}
        >
          INITIATE LOCKDOWN
        </button>
